...
subtitle: | 
  <span style="color:green"> Corte de Apelaciones de Talca </span> 
...
```{r 2, echo = FALSE}
archivos <- tibble(dir("Corte de Apelaciones de Talca/", pattern = ".xlsx"))
...
for (i in 1:limite ) {
      tryCatch( {
  direccion <- paste0("Corte de Apelaciones de Talca/",archivos$value[i])
...
for (i in archivos$value[1:nrow(archivos)]) {
        tryCatch(
      {
  direccion <- paste0("Corte de Apelaciones de Talca/",i)
...
```{r 17, echo = FALSE}
write_xlsx(tabla_1,"tablas de CadAde Talca/tabla_1.xlsx")
write_xlsx(tabla_2,"tablas de CadAde Talca/tabla_2.xlsx")
write_xlsx(tabla_3,"tablas de CadAde Talca/tabla_3.xlsx")
write_xlsx(tabla_4,"tablas de CadAde Talca/tabla_4.xlsx")
write_xlsx(tabla_5,"tablas de CadAde Talca/tabla_5.xlsx")
write_xlsx(tabla_6,"tablas de CadAde Talca/tabla_6.xlsx")
write_xlsx(tabla_7,"tablas de CadAde Talca/tabla_7.xlsx")
write_xlsx(tabla_8,"tablas de CadAde Talca/tabla_8.xlsx")
write_xlsx(tabla_9,"tablas de CadAde Talca/tabla_9.xlsx") 
write_xlsx(tabla_10,"tablas de CadAde Talca/tabla_10.xlsx") 
```
